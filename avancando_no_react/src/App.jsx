...
function App() {
  ...
  const people = [
    {id: 1, name: "Gustavo", age: 21, profession: "Estudante"},
    {id: 2, name: "Erick", age: 23, profession: "Estagiario"},
    {id: 3, name: "Logan", age: 25, profession: "Engenheiro de software"},
    {id: 3, name: "Paulo", age: 16, profession: "Estudante"},
  ]
